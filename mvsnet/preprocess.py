...
def gen_dtu_resized_path(dtu_data_folder, mode='training'):
    ...
    training_set = [2, 6, 7, 8, 14, 16, 18, 19, 20, 22, 30, 31, 36, 39, 41, 42, 44,
                    ...
                    74, 75, 76, 77, 83, 84, 85, 87, 88, 89, 90, 91, 92, 93, 94, 95, 96, 97, 98, 99, 100,
                    101, 102, 103, 104, 105, 107, 108, 109, 111, 112, 113, 115, 116, 119, 120,
                    121, 122, 123, 124, 125, 126, 127, 128, 34, 33, 15, 11, 1, 12, 23, 48, 29, 13, 49, 9, 62, 4, 32, 10, 
    ...
    #                 101, 102, 103, 104, 105, 107, 108, 109, 111, 112, 113, 115, 116, 119, 120,
    #                 121, 122, 123, 124, 125, 126, 127, 128, 34, 33, 15, 11, 1, 12, 23, 48, 29, 13, 49, 9, 62, 4, 32, 10]
    validation_set = [77,34,33,15,11,1,12,23,48,75,29,13,49,9,62,4,32,10]
    data_set = []
    if mode == 'training':
